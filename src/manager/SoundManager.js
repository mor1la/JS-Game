...
class SoundManager {
    constructor() {
        ...
        this.gainNode = null;
        this.loaded = false;
        this.sounds = ['../sounds/key.wav', '../sounds/level_up.wav', "../sounds/lose.wav", 
        "../sounds/win.wav", "../sounds/player_hit.wav", "../sounds/minecraft_door_open.wav", 
        "../sounds/get_coin.wav", "../sounds/attack.wav", "../sounds/enemy_hit.wav",
        "../sounds/heart.wav"];
    }
